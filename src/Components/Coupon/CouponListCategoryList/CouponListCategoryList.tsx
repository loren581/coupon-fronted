import "./CouponListCategoryList.css";
...
function CouponListCategoryList(): JSX.Element {

        // State = React Mechanism for managing data in component
        const[ coupons] = useState<CouponModel[]>(store.getState().couponsReducer.couponsByCategory);
...
export default CouponListCategoryList;
