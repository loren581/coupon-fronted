...
import {  gotAllCouponAction, gotAllCouponAllAction } from "../../../Redux/CouponAppState";
import CouponCard from "../CouponCard/CouponCard";

function CouponListCustomer(): JSX.Element {
        ...
        useEffect(() => {
            ...
            webApiService.getAllCouponsAsCustomer()
                .then(res => {
...
export default CouponListCustomer;
